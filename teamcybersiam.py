...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mAbdur Rahman Siam\033[1;91m...............
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/teamsiam/teamcybersiam.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('FB ACCOUNT :- https://www.facebook.com/siamahmmed01873✓')
	    psb('WellCome To SIAM_X')
	    psb('Congratulations SIAM X Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ SIAM✓')
	    psb('🔓Password ☆ 001100✓')
	    psb('Subscrib My Youtube Channel TECH BOY✓')
